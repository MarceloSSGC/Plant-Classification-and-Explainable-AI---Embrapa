...
for EXP_NAME in EXP_LIST:   # EXP_NAME = EXP_LIST[9]
    ...
    do_ablation_01(TEST_DATA_DIR, EXP_DIR, ABL_DIR)
...
def do_ablation_01(
    ...
    if not os.path.isfile(df_all_dir) or not os.path.isfile(fig_dir):
        ...
        fig_acc, ax_acc = plot_ablation_metric(df_all, title=f"Spectral Band Ablation Study - {model_name}")
