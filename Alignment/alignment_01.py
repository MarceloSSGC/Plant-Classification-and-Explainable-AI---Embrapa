...
img_norm, norm_params = load_multiband_image(
    directory="/media/marcelo/HD_8t/Marcelo__Seagate_8tb/Embrapa/Embrapa_Experimentos/Datasets/PlantaDaninha_BoaVista/01_malva_branca_Agua_Boa_01",
    image_name="IMG_0015"
)
...
# def save_multiband_image(img_aligned, directory, image_name, dtype=np.float32):
#     """
...
#         Tipo dos dados a serem salvos (default=np.float32).
#     """

#     if os.path.isdir(directory):
#         print(f"directory exist/n {directory}")
#     else:
#         print(f"directory doesntexist/n {directory}")
#         return None

#     directory = Path(directory)
#     directory.mkdir(parents=True, exist_ok=True)

#     n_bands = img_aligned.shape[-1]

#     for b in range(n_bands):
#         filename = directory / f"{image_name}_{b+1}.tif"
#         tiff.imwrite(filename, img_aligned[:, :, b].astype(dtype))
...
# with rasterio.open("../Alignment_Tests/IMG_0015_1.tif") as src:
#     band = src.read(1)

# original_img = "/media/marcelo/HD_8t/Marcelo__Seagate_8tb/Embrapa/Embrapa_Experimentos/Datasets/PlantaDaninha_BoaVista/01_malva_branca_Agua_Boa_01/IMG_0015_1.tif"
# with rasterio.open("../Alignment_Tests/IMG_0015_1.tif") as src:
