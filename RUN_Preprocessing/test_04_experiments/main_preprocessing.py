...
try:
    ...
    from .aux_multiview_functions import *
        ...
        from RUN_Preprocessing.test_04_experiments.aux_align import align_main_function
        from RUN_Preprocessing.test_04_experiments.aux_seg import *
        from RUN_Preprocessing.test_04_experiments.aux_multiview_functions import *
...
def run_preprocessing(config):
    ...
    print(f"\n\033[100;01m\t     --- Start Multiview - 5 bands ---     \t\033[0m\n")
    ...
    if DO_AUGMENTANTION:
        ...
        try:
            ...
            from RUN_Preprocessing.test_04_experiments.aux_augm import augmentation_compilation, plot_rgb
