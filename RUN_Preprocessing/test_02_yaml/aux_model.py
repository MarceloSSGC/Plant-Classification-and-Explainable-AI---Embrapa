...
class MultispectralWeedDataset(Dataset):
    def __init__(self, root_dir, transform=None):
        ...
        root_dir: diretório (TRAIN_DIR, VAL_DIR ou TEST_DIR)
                  ...
                  os arquivos .npy das imagens (H, W, 5)
...
#         history = {
#             "train_loss": [], "val_loss": [],
#             "val_acc": [], "val_f1_macro": [], "val_f1_micro": [],
#         }
...
#             # ---- validação ----
#             val_loss, val_acc, val_f1_macro, val_f1_micro = self._evaluate(
...
#         return val_loss, acc, f1_macro, f1_micro
